...
# Open the CSV file
Count = 0
with open(r"C:\Users\91999\Documents\RP\Model test\Model 1\Application\Top - MTM - Right\hand-gesture-recognition-mediapipe-main\Heatmap.csv", 'r') as file:
...
for i in range (1,Count-1):
    ...
    # real_distance = pix_dis * 0.0580110497 #inches
    real_distance = pix_dis * 0.0450110497 #inches
...
df.to_csv(r"C:\Users\91999\Documents\RP\Model test\Model 1\Application\Top - MTM - Right\hand-gesture-recognition-mediapipe-main\Time_Difference_Extractor.csv", index=False, header=False)

time.sleep(1)
#Totals
# Open the CSV file
with open(r"C:\Users\91999\Documents\RP\Model test\Model 1\Application\Top - MTM - Right\hand-gesture-recognition-mediapipe-main\Time_Difference_Extractor.csv") as csv_file:
